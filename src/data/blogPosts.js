...
NoCowboys is een creatief productiebedrijf gespecialiseerd in podcasts en branded content. Met een focus op storytelling en kwaliteit helpt NoCowboys merken en organisaties om hun verhaal te vertalen naar impactvolle formats.`,
    },
    {
        ...
        category: 'Werkwijze',
        content: `
Een professionele podcast hoeft geen weken te kosten. Bij H20 Studio gaan klanten dezelfde dag naar huis met een kant-en-klare aflevering. Hoe werkt dat precies?

## Voorbereiding: 30 minuten vóór de opname

De sleutel zit in een goede briefing vooraf. Via e-mail sturen we een korte vragenlijst op: wie zijn de gasten, wat is het onderwerp, zijn er specifieke camera-instructies? Zo staat de set al klaar als je binnenkomt.

## De opname zelf

Onze technicus/regisseur stuurt vanaf dag één alle 4 camera's en de audio live. Dat betekent dat je na de sessie al een bewerkte versie hebt — geen rauwe files die je nog moet monteren.

De 4-camera live schakeling zorgt ervoor dat elke gasten-cutaway, elke reactie en elk close-up al op het juiste moment staat.

## Direct ophalen of nabewerking

Na de sessie heb je twee opties:
- **RAW bestanden meenemen** en zelf afwerken
- **Onze nabewerking** kiezen: kleurcorrectie, audio fine-tuning, titels en desgewenst social snippets

De meeste klanten kiezen voor de nabewerking en hebben hun aflevering de volgende ochtend in de inbox.

## Conclusie

Met de juiste voorbereiding en een goed uitgerust studio-team is één dag meer dan genoeg. Plan je gratis pilot en ontdek het zelf.
        `.trim(),
    },
    {
        ...
        category: 'Tarieven',
        content: `
De prijzen voor een podcast studio in Nederland lopen enorm uiteen. Van een simpele ruimte met één microfoon tot een volledig bemand broadcast-setup. We zetten het op een rij.

## Wat kost een "gewone" studio?

De meeste studios rekenen €50–€150 per uur voor het gebruik van de ruimte. Wat er dan niet bij inzit:
- Een technicus of regisseur
- Live camera-schakeling
- Post-productie

Die extras betaal je apart, en het loopt snel op.

## Wat kost H20 Studio?

Bij H20 Studio is alles inclusief. Geen verborgen kosten voor de technicus, geen extra rekening voor de apparatuur.

- **Gratis pilot** — 30 minuten vrijblijvend kennismaken
- **1 uur** — €395 (inclusief technicus en 4-camera live)
- **2 uur** — €595
- **Halve dag** — €795

## All-in vs. losse componenten

Als je bij een goedkopere studio een technicus, post-productie en cameraman afzonderlijk boekt, betaal je al snel €600+ voor een sessie die bij H20 €395 kost.

Transparantie in pricing bespaart je niet alleen geld, maar ook verrassingen achteraf.
        `.trim(),
    },
    {
        ...
        category: 'Techniek',
        content: `
De meeste podcast studios werken met één of twee camera's die achteraf worden gemixt. Bij H20 doen we dat live, met vier camera's tegelijk. Wat maakt dat verschil?

## Live schakelen vs. achteraf monteren

Bij een achteraf-montage moet een editor urenlang door beelden scrubben om de juiste cutaways te vinden. Bij live schakeling doet onze regisseur dat real-time — het gesprek wordt gevolgd zoals het een TV-uitzending is.

Resultaat: minder montagetijd, een vloeiender eindproduct en een professionele uitstraling die je meteen ziet.

## De vier cameraposities

1. **Wide shot** — beide gasten in beeld, voor context
2. **Close-up gast 1** — voor reacties en sterke quotes
3. **Close-up gast 2** — zelfde principe
4. **Over-the-shoulder** — geeft diepte en dynamiek

Met vier posities heeft de regisseur altijd de perfecte cut klaar, ongeacht waar het gesprek naartoe gaat.

## Waarom het (nog) niet overal standaard is

Het vereist investeringen in apparatuur én in mensen. Een regisseur die live knipt is een vak apart. Bij H20 is dit standaard inbegrepen bij elk pakket.
        `.trim(),
    },
];
